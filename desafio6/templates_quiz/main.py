...
# valores iniciales - 
n_pregunta = 0 # El número de preguntas respondidas hasta el momento.
continuar = 'y'# Una variable que almacena si el usuario desea continuar jugando.
correcto = True#variable que almacena si la respuesta del usuario es correcta.
p_level = 10#número de preguntas por nivel.
